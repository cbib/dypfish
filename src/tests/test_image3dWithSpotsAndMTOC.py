...
class TestImage3dWithSpotsAndMTOC(TestCase):
    ...
    def test_compute_cytoplasmic_density(self):
        ...
        self.assertAlmostEqual(0.142879509018, result, places = 5)
    ...
    def test_compute_density_per_quadrant(self):
        ...
        self.assertAlmostEqual(result[1, 0], 0.1351229643789, places=3)
        self.assertAlmostEqual(result[:, 0].sum(), 0.549784660797, places=5)
    ...
    def test_compute_quadrant_densities(self):
        ...
        self.assertAlmostEqual(result1[:, 0].sum(), 0.528758974855, places=3)
        ...
        self.assertAlmostEqual(result3[:, 0].sum(), 1.474047751267, places=5)
    ...
    def test_compute_density_per_quadrant_and_slices(self):
        ...
        self.assertAlmostEqual(result[:,0].sum(), 1.525339250007, places=5)
