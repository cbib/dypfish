...
class TestImage3d(TestCase):
    ...
    def test_compute_cell_volume(self):
        ...
        self.assertAlmostEqual(cell_vol, 1413.781459566, places=5)
    ...
    def test_compute_median_cytoplasmic_distance_from_nucleus(self):
        ...
        self.assertAlmostEqual(median, 123.10158406779, places=5)
        self.assertAlmostEqual(max, 212.51823451177, places=5)

    def test_compute_cell_volume(self):
        volume = self.img.compute_cell_volume()
        self.assertAlmostEqual(volume, 1413.78145956, places=5)
    ...
    def test_compute_peripheral_cell_volume(self):
        ...
        self.assertAlmostEqual(volume, 133.36962524654, places=5)
    ...
    def test_compute_volumes_from_periphery(self):
        ...
        self.assertAlmostEqual(volumes.sum(), 45748.926232741, places=5)
    ...
    def test_compute_cytoplasmic_coordinates_peripheral_distance(self):
        ...
        self.assertEqual(distances[1], 28)
