...
# Figure ?? : mrna cytoplasmic spread arhgdia prrc2c
logger.info("Running mrna cytoplasmic spread analysis for prrc2c")
constants.init_config(
    analysis_config_js_path=pathlib.Path(global_root_dir, "src/analysis/cytoplasmic_spread/config_prrc2c.json"))
...
# Figure 5B : protein cytoplasmic spread arhgdia prrc2c
logger.info("Running protein cytoplasmic spread analysis for prrc2c")
gene2image_set = {}
gene2cyto_count = {}
