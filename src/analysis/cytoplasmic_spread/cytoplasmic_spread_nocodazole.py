...
constants.init_config(analysis_config_js_path=pathlib.Path(global_root_dir, "src/analysis/cytoplasmic_spread/config_nocodazole_arhgdia.json"))
...
# Figure 5B top right panel : protein cytoplasmic spread arhgdia, pard3, arhgdia and pard3 nocodazole
...
constants.init_config(analysis_config_js_path=pathlib.Path(global_root_dir, "src/analysis/cytoplasmic_spread/config_nocodazole_pard3.json"))
