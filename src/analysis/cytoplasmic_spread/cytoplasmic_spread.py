...
# Figure 5B : mrna cytoplasmic spread arhgdia, pard3, arhgdia and pard3 original
constants.init_config(analysis_config_js_path=pathlib.Path(global_root_dir, "src/analysis/cytoplasmic_spread/config_original.json"))
...
logger.info("Running mrna cytoplasmic spread analysis for original data")
gene2image_set = {}
gene2cyto_count = {}
...
# Figure 5B : protein cytoplasmic spread arhgdia, pard3, arhgdia and pard3 original data
logger.info("Running protein cytoplasmic spread analysis for original data")
gene2image_set = {}
gene2cyto_count = {}
