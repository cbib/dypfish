...
if __name__ == '__main__':
    ...
    for conf in configurations:
        ...
        mrna_tis_dict = compute_mrna_relative_density_per_quadrants_and_slices(repo, quadrants_num=8)
        prot_tis_dict = compute_protein_relative_density_per_quadrants_and_slices(repo, quadrants_num=8)
