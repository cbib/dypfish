...
h_star_chx_file_path = analysis_data_dir + 'h_star_chx.h5'
basic_file_chx_path = analysis_data_dir + 'basic_chx.h5'
secondary_file_chx_path = analysis_data_dir + 'secondary_chx.h5'
