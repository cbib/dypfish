    ...
    with h5py.File(path.data_dir+input_dir_name+'/'+basic_file_name, "r") as file_handler,\
        ...
        for mrna in mrnas:
            ...
            for timepoint in mrna_timepoints:
                ...
                mrna_tp_df.to_csv(path.analysis_dir+"nocodazole/dataframe/"+mrna + '_' + timepoint + "_mrna.csv")
                time_count += 1
            gene_count += 1
        ...
        for protein in proteins:
            ...
            for timepoint in prot_timepoints:
                ...
                prot_tp_df.to_csv(path.analysis_dir+"nocodazole/dataframe/"+protein + '_' + timepoint + "_protein.csv")
                time_count += 1
            gene_count += 1