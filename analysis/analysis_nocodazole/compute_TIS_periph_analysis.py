...
def main():
    ...
    for mrna in mrnas:
        ...
        for timepoint in mrna_timepoints:
           ...
           # mrna_df = pd.read_csv(path.analysis_dir + "analysis_temporal_interactions/dataframe/" + mrna + '_' + timepoint +"_"+limit+ "_mrna.csv",index_col=0)
        ...
        for timepoint in prot_timepoints:
            ...
            #prot_df = pd.read_csv(path.analysis_dir + "analysis_temporal_interactions/dataframe/" + mrna + '_' + timepoint +"_"+limit+ "_protein.csv",index_col=0)
