    ...
    with h5py.File(path.basic_file_path, "r") as file_handler, \
        ...
        for mrna in mrnas:
            ...
            for timepoint in mrna_timepoints:
                ...
                #mrna_tp_df.to_csv(check_dir(path.analysis_dir + "analysis_temporal_interactions/dataframe/") +mrna + '_' + timepoint+ '_' +str(limit) +"_mrna.csv")
                time_count += 1
            gene_count += 1
        ...
        for protein in proteins:
            ...
            for timepoint in prot_timepoints:
                ...
                #prot_tp_df.to_csv(path.analysis_dir + "analysis_temporal_interactions/dataframe/" + protein + '_' + timepoint+ '_' +str(limit) +"_protein.csv")
