...
def cytoplasmic_spread(file_handler, genes, image_width, image_height,molecule_type):
    cyt_spreads = []
...
def main():
    ...
    with h5py.File(path.data_dir+input_dir_name+"/"+basic_file_name, "r") as file_handler:
        cytoplasmic_spread(file_handler, genes, image_width, image_height, molecule_type='mrna')
        cytoplasmic_spread(file_handler, genes, image_width, image_height, molecule_type='protein')
