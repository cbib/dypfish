...
if __name__ == "__main__":
	...
	#compute quadrant
	with h5py.File(path.data_dir + input_dir_name +'/'+ basic_file_name, "a") as file_handler, h5py.File(path.data_dir + input_dir_name +'/'+ secondary_file_name, "a") as secondary_file_handler:
		vmr_values_sig = []
		for gene in genes:
			print(gene)
			image_list=[]
