...
if __name__ == "__main__":
                ...
                for im in file_handler[molecule_type[0] + '/' + gene + '/' + timepoint]:
                    ...
                    for i in range(len(cell_masks_im)):
                        ...
                        if u - 200 < nuc_d < u + 200:
                            ...
                            spots_reduced = spots_reduced[spots_reduced[:,2] > 20]

                            spots_reduced = spots_reduced[spots_reduced[:, 2] < (len(z_lines)-20)]
                            ...
                            for spot in spots_reduced:
                                print("spots " + str(spots_count))
                                #if 15 < spot[2] < len(z_lines)-15:
                            ...
                            print("mask " +str(mask_count))
                            mask_count+=1
                        total_profile = np.array(total_profile).reshape((mask_count, 15))
    ...
    df.to_csv("all_median_profiles_by_slice.csv")
