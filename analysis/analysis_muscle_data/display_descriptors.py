...
def show_cell_mask(cell_mask,spots,nucleus_mask):
...
def show_z_line_mask(z_lines,spots,nucleus_mask):
        ...
        for gene in genes:
            ...
            for timepoint in timepoints:
                ...
                for im in muscle_file_handler[molecule_type[0] + '/' + gene + '/' + timepoint]:
                    ...
                    show_cell_mask(cell_mask,spots_reduced,nucleus_mask)
                    #show_z_line_mask(z_lines, all_spots, nucleus_mask)
