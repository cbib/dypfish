...
def get_data_wo_nucleus(basic_h5_file_handler,
    ...
    for timepoint in timepoints:
        for gene in genes:
            ...
            graph_file_path_name = os.path.join("/Users/benjamin/Downloads/dypfish/analysis/analysis_spots_density/figures/", graph_file_name)
...
if __name__ == "__main__":
    ...
    save_into_dir_path_name = os.path.join(path.analysis_dir, "analysis_spots_density/figures/")
